...
| [0007: Long failure continuation](0007-thinking-failure-continuation.md) | Accepted | Same-task continuation only after each failed response exceeds 60 minutes |

Records describe the custom `5.0.7-pro-context.1` build and updates through `5.0.7-pro-context.4`, based on upstream commit
